...
REM pscoast -R119.85/123.1/21.5/25.5 -B1WSne -JM15 -Di -W3  -Lf122.4/22.5/10/100+u -K  -V -P > ex1.ps
...
psxy dis_pro_time  -R -JM -W6/255/0/0 -G255/255/0 -Sc -K  -O -V >> ex1.ps
REM psxy dis_pro_time_09  -R -JM -W5/255/0/0 -G255/255/0 -Sc -K  -O -V >> ex1.ps
REM psxy cwb2013.txt     -R -JM -W1  -G125  -St0.2 -K -O -V >> ex1.ps
REM psxy ext2013.txt     -R -JM -W1  -G125  -St0.2 -K -O -V >> ex1.ps

psxy dot  -R -JM -W5/255/0/0 -G255/255/0  -Sc -K  -O -V >> ex1.ps
...
rem pstext	time_txt1	 -R -JM -W1/0/0/0 -K -O -V >> ex1.ps
pstext	legend_time1_txt2.txt	 -R -JM -W1/0/0/0 -O -V >> ex1.ps
...
ps2raster ex1.ps -GD:\programs\gs\gs9.22\bin\gswin64c -A -Tg -V
